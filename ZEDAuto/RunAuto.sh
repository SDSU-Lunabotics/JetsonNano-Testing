...
if [[ "${DRIVE:-1}" == "1" ]]; then
  ...
  cmd+=(--drive-stop-turn-deg "${DRIVE_STOP_TURN_DEG:-60.0}")
  cmd+=(--drive-heading-tol-deg "${DRIVE_HEADING_TOL_DEG:-18.0}")
  cmd+=(--drive-tracking-warmup-sec "${DRIVE_TRACKING_WARMUP_SEC:-2.5}")
