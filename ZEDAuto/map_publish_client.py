...
class HttpMapPublisher:
    ...
    def _publish_frame(self, frame) -> None:
        ...
        if not ok:
            self._rate_limited_log("Failed to encode occupancy map as JPEG for HTTP publish.")
            return
        ...
        try:
            ...
            self._rate_limited_log(f"Map publish failed: {exc}")
