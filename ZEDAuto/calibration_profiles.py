...
class ControllerMacroLibrary:
    ...
    def capture_sample(
        ...
        signature = (
            ...
            sample["lower_on"],
            sample["stow_on"],
            sample["manual_extend_on"],
            sample["manual_retract_on"],
            sample["left_extend_on"],
            sample["right_extend_on"],
            sample["door_open_on"],
    ...
    def playback_sample_for_macro(self, macro, elapsed_sec, mode="forward", mechanism_hold_sec=0.0, suppress_mechanisms=False):
        ...
        return {
            ...
            "conveyor_on": False if suppress_mechanisms else bool(sample.get("conveyor_on", False)),
            "lower_on": _bool_with_hold("lower_on"),
            "stow_on": _bool_with_hold("stow_on"),
            "manual_extend_on": _bool_with_hold("manual_extend_on"),
            "manual_retract_on": _bool_with_hold("manual_retract_on"),
...
# Backwards-compatibility aliases for older typoed call sites.
controllermacrollibraty = ControllerMacroLibrary
ControllerMacroLibraty = ControllerMacroLibrary
