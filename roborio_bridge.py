...
DATA_KEYS = {
    ...
    "Excav/BotLeftInches": "number",
    "Excav/BotRightInches": "number",
    "Excav/BotLeftExtensionPct": "number",
    "Excav/BotRightExtensionPct": "number",
    ...
    "Jetson/ExcavatorLeftExtensionPct": "number",
    "Jetson/ExcavatorRightExtensionPct": "number",
    "Jetson/ExcavatorLeftExtensionInches": "number",
    "Jetson/ExcavatorRightExtensionInches": "number",
    "Jetson/ExcavatorBottomPositionCalibrated": "boolean",
